...
import it.water.infrastructure.apigateway.service.ApiGatewayApplication;
...
public class ApiGatewayRestSpringApiTest {
    ...
    Karate restInterfaceTest() {
        return Karate.run("../ApiGateway-service/src/test/resources/karate")
